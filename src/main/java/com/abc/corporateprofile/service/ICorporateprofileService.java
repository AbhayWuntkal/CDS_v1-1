...
//	public List<User_Details> logout(int userid, String last_login_date);
	...
	public void updateUserInfo(String email_id,String phone_number,Boolean is_meal,boolean is_baggage,boolean is_hold_booking,boolean is_approver,boolean is_travel_arranger,boolean is_trip_claim_approver);
	public void updatePersonalInfo(String email_id,String title,String fname,String last_name,String gender,String residency,String nationality,
			String dob,boolean is_flight_arranger_group,boolean is_flight_approver_group,String profile_type,
			Integer htl_travel_arranger_group,Integer htl_approver_group,Integer claim_approver_group);
...
//	public void deleteGSTDetailsbynumber(int gst_number); 
	...
	public List<User_Details> searchUsers(Integer userid, String fname, String user_type, String status, String email_id, String phone_number);
...
//	add,get,update
	...
	public void UpdateinsurancebybyUid(Integer  userid,String insurer,String region,Integer policy_no,String start_date,String end_date,String nominee);
