...
//	}
	...
	public void logout( @RequestParam("email_id") String email_id,@RequestParam("last_login_date") String last_login_date) {
	...
	public void changepassword( @RequestParam("password") String password,
			...
			@RequestParam("last_modified_date")String last_modified_date,@RequestParam("modified_by") String modified_by,
			@RequestParam("new_password") String new_password) {
		cdsservice.changepassword( password,email_id,last_modified_date,modified_by,new_password );
	}
		
	@PostMapping(value = "/updateUserInfo")
	public void updateUserInfo( @RequestParam("email_id")  String email_id,
			@RequestParam("phone_number") String phone_number, 
			@RequestParam("is_meal")Boolean is_meal,
			@RequestParam("is_baggage") boolean is_baggage,
			@RequestParam("is_hold_booking") boolean is_hold_booking,
			@RequestParam("is_approver") boolean is_approver,
			@RequestParam("is_travel_arranger") boolean is_travel_arranger,
			@RequestParam("is_trip_claim_approver") boolean is_trip_claim_approver) {
	...
	public void updatePersonalInfo(@RequestParam("email_id")String email_id,
			...
			@RequestParam("is_flight_arranger_group")boolean is_flight_arranger_group,
			@RequestParam("is_flight_approver_group")boolean is_flight_approver_group,
			@RequestParam("profile_type") String profile_type, 
			@RequestParam("htl_travel_arranger_group")Integer htl_travel_arranger_group,
			@RequestParam("htl_approver_group")Integer htl_approver_group,
			@RequestParam("claim_approver_group") Integer claim_approver_group){
	...
	@PostMapping(value = "/updateOrgDetails")
	public void updateOrgInfo(@PathVariable("id")Integer id,
			@RequestParam("employee_code") String employee_code,
			@RequestParam("designation") String designation, 
			@RequestParam("band")String band,
			@RequestParam("location") String location,
			@RequestParam("department")String department,
			@RequestParam("cost_center") String cost_center,
			@RequestParam("project_code") String project_code,
			@RequestParam("domestic_eligibility") String domestic_eligibility,
			@RequestParam("international_eligibility")String international_eligibility,
			@RequestParam("date_of_joining") String date_of_joining,
			@RequestParam("date_of_termination") String date_of_termination){
	...
	@GetMapping(value = "/gstDetails/{email}") //pathvariable
	public List<GST_Details> getGSTDetails(@PathVariable("email") String user_email) {
		//System.out.println(prodName);
		return cdsservice.getGSTDetails(user_email);	
	}
...
//	lnk_user_role
	...
	@PostMapping(value = "/updateuserRolebyid")
	public void UpdateuserRolebyid(@RequestParam("userid") Integer  userid,
			@RequestParam("roleid") Integer roleid,
			@RequestParam("last_modified_date")  String last_modified_date,
...
//	Passport_master
	...
	@PostMapping(value = "/updatepassportbybyid")
	public void Updatepassportbybyid(@RequestParam("userid")Integer userid, 
	...
	public void deletepassport(@PathVariable("id") int id) 
	{
		cdsservice.deletepassport(id);
	}
...
//	visa
	...
	@PostMapping(value = "/updatevisabybyUid")
	public void UpdatevisabybyUid(@RequestParam("userid")Integer userid,
			@RequestParam("expiry_date")String expiry_date,
			@RequestParam("modified_date") String modified_date,
			@RequestParam("modified_by") String modified_by) {
...
//	insurance
	...
	@PostMapping(value = "/updateinsurancebybyUid")
	public void UpdateinsurancebybyUid(@RequestParam("userid")Integer userid,
			@RequestParam("insurer") String insurer,
			@RequestParam("region") String region,
			@RequestParam("policy_no") Integer policy_no,
	...
	private void deletegst(@PathVariable("id") int id) 
	{
		cdsservice.deleteGSTDetails(id);
	}
