...
//	}
	...
	public void logout(@PathVariable("email_id") String email_id,
			@PathVariable("last_login_date") String last_login_date) {
	...
	public void changepassword(@PathVariable("password") String password, @PathVariable("email_id") String email_id,
			@PathVariable("last_modified_date") String last_modified_date,
			@PathVariable("modified_by") String modified_by, @PathVariable("new_password") String new_password) {
	...
	public void updateUserInfo(@PathVariable("email_id") String email_id,
			@PathVariable("phone_number") String phone_number, @PathVariable("is_meal") Boolean is_meal,
			@PathVariable("is_baggage") boolean is_baggage, @PathVariable("is_hold_booking") boolean is_hold_booking,
			@PathVariable("is_approver") boolean is_approver,
			@PathVariable("is_travel_arranger") boolean is_travel_arranger,
			@PathVariable("is_trip_claim_approver") boolean is_trip_claim_approver) {
		cdsservice.updateUserInfo(email_id, phone_number, is_meal, is_baggage, is_hold_booking, is_approver,
	...
	public void updatePersonalInfo(@PathVariable("email_id") String email_id, @PathVariable("title") String title,
			@PathVariable("fname") String fname, @PathVariable("last_name") String last_name,
			@PathVariable("gender") String gender, @PathVariable("residency") String residency,
			@PathVariable("nationality") String nationality, @PathVariable("dob") String dob,
			@PathVariable("is_flight_arranger_group") boolean is_flight_arranger_group,
			@PathVariable("is_flight_approver_group") boolean is_flight_approver_group,
			@PathVariable("profile_type") String profile_type,
			@PathVariable("htl_travel_arranger_group") Integer htl_travel_arranger_group,
			@PathVariable("htl_approver_group") Integer htl_approver_group,
			@PathVariable("claim_approver_group") Integer claim_approver_group) {
		cdsservice.updatePersonalInfo(email_id, title, fname, last_name, gender, residency, nationality, dob,
	...
	public void updateOrgInfo(@PathVariable("id") Integer id, @PathVariable("employee_code") String employee_code,
			@PathVariable("designation") String designation, @PathVariable("band") String band,
			@PathVariable("location") String location, @PathVariable("department") String department,
			@PathVariable("cost_center") String cost_center, @PathVariable("project_code") String project_code,
			@PathVariable("domestic_eligibility") String domestic_eligibility,
			@PathVariable("international_eligibility") String international_eligibility,
			@PathVariable("date_of_joining") String date_of_joining,
			@PathVariable("date_of_termination") String date_of_termination) {
		cdsservice.updateOrgInfo(id, employee_code, designation, band, location, department, cost_center, project_code,
				domestic_eligibility, international_eligibility, date_of_joining, date_of_termination);
	}
	...
	public List<User_Details> searchUsers(@PathVariable("userid") Integer userid, @PathVariable("fname") String fname,
			@PathVariable("user_type") String user_type, @PathVariable("status") String status,
			@PathVariable("email_id") String email_id, @PathVariable("phone_number") String phone_number) {
...
//	lnk_user_role
	...
	public void UpdateuserRolebyid(@PathVariable("userid") Integer userid, @PathVariable("roleid") Integer roleid,
			@PathVariable("last_modified_date") String last_modified_date,
			@PathVariable("modified_by") String modified_by) {
...
//	Passport_master
	...
	public void Updatepassportbybyid(@PathVariable("userid") Integer userid,
			@PathVariable("expiry_date") String expiry_date, @PathVariable("modified_date") String modified_date,
			@PathVariable("modified_by") String modified_by) {
...
//	visa
	...
	public void UpdatevisabybyUid(@PathVariable("userid") Integer userid,
			@PathVariable("expiry_date") String expiry_date, @PathVariable("modified_date") String modified_date,
			@PathVariable("modified_by") String modified_by) {
...
//	insurance
	...
	public void UpdateinsurancebybyUid(@PathVariable("userid") Integer userid, @PathVariable("insurer") String insurer,
			@PathVariable("region") String region, @PathVariable("policy_no") Integer policy_no,
			@PathVariable("start_date") String start_date, @PathVariable("end_date") String end_date,
			@PathVariable("nominee") String nominee) {
