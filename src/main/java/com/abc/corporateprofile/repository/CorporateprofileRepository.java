...
public interface CorporateprofileRepository extends JpaRepository<User_Details, Integer> {
	...
	public void changepassword(@Param("password") String password, @Param("email_id") String email_id,
			@Param("last_modified_date") String last_modified_date, @Param("modified_by") String modified_by,
	...
	public void UpdateuserRolebyid(@Param("userid") Integer userid, @Param("roleid") Integer roleid,
			@Param("last_modified_date") String last_modified_date, @Param("modified_by") String modified_by);
	...
	public void Updatepassportbybyid(@Param("userid") Integer userid, @Param("expiry_date") String expiry_date,
			@Param("modified_date") String modified_date, @Param("modified_by") String modified_by);
	...
	public void updateUserInfo(@Param("email_id") String email_id, @Param("phone_number") String phone_number,
			@Param("is_meal") Boolean is_meal, @Param("is_baggage") boolean is_baggage,
			@Param("is_hold_booking") boolean is_hold_booking, @Param("is_approver") boolean is_approver,
			@Param("is_travel_arranger") boolean is_travel_arranger,
			@Param("is_trip_claim_approver") boolean is_trip_claim_approver);
	...
	public void updatePersonalInfo(@Param("email_id") String email_id, @Param("title") String title,
			@Param("fname") String fname, @Param("last_name") String last_name, @Param("gender") String gender,
			@Param("residency") String residency, @Param("nationality") String nationality, @Param("dob") String dob,
			@Param("is_flight_arranger_group") boolean is_flight_arranger_group,
			@Param("is_flight_approver_group") boolean is_flight_approver_group,
			@Param("profile_type") String profile_type,
			@Param("htl_travel_arranger_group") Integer htl_travel_arranger_group,
			@Param("htl_approver_group") Integer htl_approver_group,
			@Param("claim_approver_group") Integer claim_approver_group);
	...
	public void updateOrgInfo(@Param("id") Integer id, @Param("employee_code") String employee_code,
			@Param("designation") String designation, @Param("band") String band, @Param("location") String location,
			@Param("department") String department, @Param("cost_center") String cost_center,
			@Param("project_code") String project_code, @Param("domestic_eligibility") String domestic_eligibility,
			@Param("international_eligibility") String international_eligibility,
			@Param("date_of_joining") String date_of_joining, @Param("date_of_termination") String date_of_termination);
	...
	public void UpdatevisabybyUid(@Param("userid") Integer userid, @Param("expiry_date") String expiry_date,
			@Param("modified_date") String modified_date, @Param("modified_by") String modified_by);
	...
	public void UpdateinsurancebybyUid(@Param("userid") Integer userid, @Param("insurer") String insurer,
			@Param("region") String region, @Param("policy_no") Integer policy_no,
			@Param("start_date") String start_date, @Param("end_date") String end_date,
			@Param("nominee") String nominee);
